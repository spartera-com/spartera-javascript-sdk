...
export default class FavoritesApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response} and HTTP response
     */
    companiesCompanyIdUsersUserIdFavoritesCategoryCategoryGetWithHttpInfo(companyId, userId, category) {
      ...
      let returnType = CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response;
     ...
     * @param {String} userId 
     * @param {String} category 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response}
     */
     ...
     */
    companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchWithHttpInfo(companyId, userId, favoriteId, favoritesUpdate) {
      ...
      if (favoritesUpdate === undefined || favoritesUpdate === null) {
        throw new Error("Missing the required parameter 'favoritesUpdate' when calling companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch");
      }
     ...
     */
    companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch(companyId, userId, favoriteId, favoritesUpdate) {
      return this.companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchWithHttpInfo(companyId, userId, favoriteId, favoritesUpdate)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    companiesCompanyIdUsersUserIdFavoritesPostWithHttpInfo(companyId, userId, favoritesInput) {
      ...
      if (favoritesInput === undefined || favoritesInput === null) {
        throw new Error("Missing the required parameter 'favoritesInput' when calling companiesCompanyIdUsersUserIdFavoritesPost");
      }
     ...
     */
    companiesCompanyIdUsersUserIdFavoritesPost(companyId, userId, favoritesInput) {
      return this.companiesCompanyIdUsersUserIdFavoritesPostWithHttpInfo(companyId, userId, favoritesInput)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

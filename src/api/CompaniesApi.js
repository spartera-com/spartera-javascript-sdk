...
export default class CompaniesApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CompaniesCompanyIdAnalyticsAssetsGet200Response} and HTTP response
     */
    companiesCompanyIdAnalyticsAssetsGetWithHttpInfo(companyId) {
      ...
      let returnType = CompaniesCompanyIdAnalyticsAssetsGet200Response;
     ...
     * Get asset performance analytics     Query params: start_date, end_date, limit, sort_by, include
     * @param {String} companyId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CompaniesCompanyIdAnalyticsAssetsGet200Response}
     */
     ...
     * @param {String} companyId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CompaniesCompanyIdGet200Response} and HTTP response
     */
     ...
     * Get details of the requestor's own company
     * @param {String} companyId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CompaniesCompanyIdGet200Response}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CompaniesCompanyIdPatch200Response} and HTTP response
     */
    companiesCompanyIdPatchWithHttpInfo(companyId, companiesUpdate) {
      ...
      if (companiesUpdate === undefined || companiesUpdate === null) {
        throw new Error("Missing the required parameter 'companiesUpdate' when calling companiesCompanyIdPatch");
      }
      ...
      let accepts = ['application/json'];
      let returnType = CompaniesCompanyIdPatch200Response;
      return this.apiClient.callApi(
     ...
     * @param {String} companyId 
     * @param {module:model/CompaniesUpdate} companiesUpdate 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CompaniesCompanyIdPatch200Response}
     */
    companiesCompanyIdPatch(companyId, companiesUpdate) {
      return this.companiesCompanyIdPatchWithHttpInfo(companyId, companiesUpdate)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

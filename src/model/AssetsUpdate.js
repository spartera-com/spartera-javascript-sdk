...
/**
 * The AssetsUpdate model module.
 * @module model/AssetsUpdate
 * @version 1.25.0
 */
class AssetsUpdate {
    /**
     * Constructs a new <code>AssetsUpdate</code>.
     * Update schema for modifying Asset
     * @alias module:model/AssetsUpdate
     */
    constructor() { 
        
        AssetsUpdate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssetsUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssetsUpdate} obj Optional instance to populate.
     * @return {module:model/AssetsUpdate} The populated <code>AssetsUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssetsUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>AssetsUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssetsUpdate</code>.
     */
 ...
 */
AssetsUpdate.prototype['user_id'] = undefined;
 ...
 */
AssetsUpdate.prototype['company_id'] = undefined;

/**
 * Optional.
 * @member {String} connection_id
 */
AssetsUpdate.prototype['connection_id'] = undefined;
 ...
 */
AssetsUpdate.prototype['industry_id'] = undefined;

/**
 * Primary use case for this asset, from clustering analysis
 * @member {Number} auc_id
 */
AssetsUpdate.prototype['auc_id'] = undefined;
 ...
 */
AssetsUpdate.prototype['function_id'] = undefined;

/**
 * Approval status for AI-generated assets
 * @member {module:model/AssetsUpdate.ApprovalStatusEnum} approval_status
 */
AssetsUpdate.prototype['approval_status'] = undefined;

/**
 * User who approved this asset for marketplace
 * @member {String} approved_by_user_id
 */
AssetsUpdate.prototype['approved_by_user_id'] = undefined;

/**
 * When this asset was approved for marketplace
 * @member {Date} approved_at
 */
AssetsUpdate.prototype['approved_at'] = undefined;

/**
 * Required.
 * @member {String} name
 */
AssetsUpdate.prototype['name'] = undefined;

/**
 * Optional.
 * @member {String} slug
 */
AssetsUpdate.prototype['slug'] = undefined;

/**
 * Optional.
 * @member {String} description
 */
AssetsUpdate.prototype['description'] = undefined;

/**
 * Long-form HTML description for product pages and SEO
 * @member {String} detailed_description
 */
AssetsUpdate.prototype['detailed_description'] = undefined;

/**
 * Required. One of: MANUAL, AUTOMATIC.
 * @member {module:model/AssetsUpdate.SourceEnum} source
 */
AssetsUpdate.prototype['source'] = undefined;

/**
 * Optional. One of: CALCULATION, VISUALIZATION, DATA.
 * @member {module:model/AssetsUpdate.AssetTypeEnum} asset_type
 */
AssetsUpdate.prototype['asset_type'] = undefined;

/**
 * Stores database table schema data including columns, types, and metadata
 * @member {Object} asset_schema
 */
AssetsUpdate.prototype['asset_schema'] = undefined;

/**
 * Optional.
 * @member {String} tags
 */
AssetsUpdate.prototype['tags'] = undefined;
 ...
 */
AssetsUpdate.prototype['viz_spec'] = undefined;

/**
 * Optional. One of: PLOTLY, MATPLOTLIB, SEABORN.
 * @member {module:model/AssetsUpdate.VizChartLibraryEnum} viz_chart_library
 */
AssetsUpdate.prototype['viz_chart_library'] = undefined;

/**
 * Optional. One of: LINE, BAR, PIE, DOUGHNUT, POLAR, … (8 total).
 * @member {module:model/AssetsUpdate.VizChartTypeEnum} viz_chart_type
 */
AssetsUpdate.prototype['viz_chart_type'] = undefined;

/**
 * Optional.
 * @member {String} viz_dep_var_col_name
 */
AssetsUpdate.prototype['viz_dep_var_col_name'] = undefined;

/**
 * Optional.
 * @member {String} viz_indep_var_col_name
 */
AssetsUpdate.prototype['viz_indep_var_col_name'] = undefined;

/**
 * Optional.
 * @member {String} viz_size_col_name
 */
AssetsUpdate.prototype['viz_size_col_name'] = undefined;

/**
 * Optional.
 * @member {String} viz_color_col_name
 */
AssetsUpdate.prototype['viz_color_col_name'] = undefined;

/**
 * Optional. One of: No Aggregation, Sum, Average, Count, Minimum, … (6 total).
 * @member {module:model/AssetsUpdate.VizDataAggregationEnum} viz_data_aggregation
 */
AssetsUpdate.prototype['viz_data_aggregation'] = undefined;

/**
 * Optional. One of: No Sorting, Ascending, Descending.
 * @member {module:model/AssetsUpdate.VizSortDirectionEnum} viz_sort_direction
 */
AssetsUpdate.prototype['viz_sort_direction'] = undefined;

/**
 * Optional.
 * @member {Number} viz_data_limit
 */
AssetsUpdate.prototype['viz_data_limit'] = undefined;

/**
 * Optional. One of: Default, Sequential, Diverging, Categorical, Monochrome, … (8 total).
 * @member {module:model/AssetsUpdate.VizColorSchemeEnum} viz_color_scheme
 */
AssetsUpdate.prototype['viz_color_scheme'] = undefined;

/**
 * Show/hide chart legend
 * @member {Boolean} viz_show_legend
 */
AssetsUpdate.prototype['viz_show_legend'] = undefined;

/**
 * Show/hide grid lines
 * @member {Boolean} viz_show_grid
 */
AssetsUpdate.prototype['viz_show_grid'] = undefined;

/**
 * Show trendline for scatter/line charts
 * @member {Boolean} viz_show_trendline
 */
AssetsUpdate.prototype['viz_show_trendline'] = undefined;

/**
 * Enable smoothing for line charts
 * @member {Boolean} viz_line_smoothing
 */
AssetsUpdate.prototype['viz_line_smoothing'] = undefined;

/**
 * Stack bars instead of grouping
 * @member {Boolean} viz_bar_stacked
 */
AssetsUpdate.prototype['viz_bar_stacked'] = undefined;

/**
 * Whether data_limit shows TOP or BOTTOM N
 * @member {module:model/AssetsUpdate.VizFilterDirectionEnum} viz_filter_direction
 */
AssetsUpdate.prototype['viz_filter_direction'] = undefined;

/**
 * Required.
 * @member {Boolean} allow_params
 */
AssetsUpdate.prototype['allow_params'] = undefined;

/**
 * Required.
 * @member {Boolean} accept_terms
 */
AssetsUpdate.prototype['accept_terms'] = undefined;

/**
 * Optional.
 * @member {Boolean} cached
 */
AssetsUpdate.prototype['cached'] = undefined;

/**
 * Optional.
 * @member {String} schedule
 */
AssetsUpdate.prototype['schedule'] = undefined;

/**
 * Optional.
 * @member {Date} next_run
 */
AssetsUpdate.prototype['next_run'] = undefined;

/**
 * Start date of the data time period covered
 * @member {Date} data_time_period_start
 */
AssetsUpdate.prototype['data_time_period_start'] = undefined;

/**
 * End date of the data time period covered
 * @member {Date} data_time_period_end
 */
AssetsUpdate.prototype['data_time_period_end'] = undefined;
 ...
 */
AssetsUpdate.prototype['date_collection_start'] = undefined;

/**
 * Type of geographic coverage
 * @member {module:model/AssetsUpdate.GeographicCoverageTypeEnum} geographic_coverage_type
 */
AssetsUpdate.prototype['geographic_coverage_type'] = undefined;

/**
 * Specific regions/countries covered (e.g., 'United States, Canada, Mexico')
 * @member {String} geographic_coverage_details
 */
AssetsUpdate.prototype['geographic_coverage_details'] = undefined;

/**
 * How often the source data is refreshed
 * @member {module:model/AssetsUpdate.DataSourceRefreshFrequencyEnum} data_source_refresh_frequency
 */
AssetsUpdate.prototype['data_source_refresh_frequency'] = undefined;

/**
 * Number of requests allowed per period (e.g., 100)
 * @member {Number} rate_limit_number
 */
AssetsUpdate.prototype['rate_limit_number'] = undefined;

/**
 * Time period for rate limiting (second, minute, hour, day)
 * @member {module:model/AssetsUpdate.RateLimitPeriodEnum} rate_limit_period
 */
AssetsUpdate.prototype['rate_limit_period'] = undefined;

/**
 * Granularity level for rate limiting (USER, COMPANY, IP)
 * @member {module:model/AssetsUpdate.RateLimitGranularityEnum} rate_limit_granularity
 */
AssetsUpdate.prototype['rate_limit_granularity'] = undefined;
 ...
 * @readonly
 */
AssetsUpdate['ApprovalStatusEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['VizChartLibraryEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['VizDataAggregationEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['VizSortDirectionEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['VizColorSchemeEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['VizFilterDirectionEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['GeographicCoverageTypeEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['DataSourceRefreshFrequencyEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['RateLimitPeriodEnum'] = {
 ...
 * @readonly
 */
AssetsUpdate['RateLimitGranularityEnum'] = {

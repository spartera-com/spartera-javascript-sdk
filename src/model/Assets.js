...
class Assets {
     ...
     * @param source {module:model/Assets.SourceEnum} Required. One of: MANUAL, AUTOMATIC.
     * @param sellInMarketplace {Boolean} Required.
     * @param requireCustomization {Boolean} Whether this asset requires customization before use
     * @param allowParams {Boolean} Required.
     * @param acceptTerms {Boolean} Required.
     */
    constructor(companyId, name, source, sellInMarketplace, requireCustomization, allowParams, acceptTerms) { 
        
        Assets.initialize(this, companyId, name, source, sellInMarketplace, requireCustomization, allowParams, acceptTerms);
    }
     ...
     */
    static initialize(obj, companyId, name, source, sellInMarketplace, requireCustomization, allowParams, acceptTerms) { 
        obj['company_id'] = companyId;
        obj['name'] = name;
        obj['source'] = source;
        obj['sell_in_marketplace'] = sellInMarketplace;
        obj['require_customization'] = requireCustomization;
...
Assets.RequiredProperties = ["company_id", "name", "source", "sell_in_marketplace", "require_customization", "allow_params", "accept_terms"];
 ...
 */
Assets.prototype['auc_id'] = undefined;
 ...
 */
Assets.prototype['function_id'] = undefined;

/**
 * Approval status for AI-generated assets
 * @member {module:model/Assets.ApprovalStatusEnum} approval_status
 */
 ...
 */
Assets.prototype['detailed_description'] = undefined;
 ...
 */
Assets.prototype['viz_show_legend'] = undefined;

/**
 * Show/hide grid lines
 * @member {Boolean} viz_show_grid
 */
Assets.prototype['viz_show_grid'] = undefined;

/**
 * Show trendline for scatter/line charts
 * @member {Boolean} viz_show_trendline
 */
Assets.prototype['viz_show_trendline'] = undefined;

/**
 * Enable smoothing for line charts
 * @member {Boolean} viz_line_smoothing
 */
Assets.prototype['viz_line_smoothing'] = undefined;

/**
 * Stack bars instead of grouping
 * @member {Boolean} viz_bar_stacked
 */
Assets.prototype['viz_bar_stacked'] = undefined;

/**
 * Whether data_limit shows TOP or BOTTOM N
 * @member {module:model/Assets.VizFilterDirectionEnum} viz_filter_direction
 */
Assets.prototype['viz_filter_direction'] = undefined;
 ...
 */
Assets.prototype['rate_limit_number'] = undefined;

/**
 * Time period for rate limiting (second, minute, hour, day)
 * @member {module:model/Assets.RateLimitPeriodEnum} rate_limit_period
 */
Assets.prototype['rate_limit_period'] = undefined;

/**
 * Granularity level for rate limiting (USER, COMPANY, IP)
 * @member {module:model/Assets.RateLimitGranularityEnum} rate_limit_granularity
 */
Assets.prototype['rate_limit_granularity'] = undefined;
 ...
 * @readonly
 */
Assets['RateLimitGranularityEnum'] = {

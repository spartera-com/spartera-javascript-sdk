...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.AlertsInput();
  });
  ...
  describe('AlertsInput', function() {
    it('should create an instance of AlertsInput', function() {
      ...
      //var instance = new SparteraApiDocumentation.AlertsInput();
      //expect(instance).to.be.a(SparteraApiDocumentation.AlertsInput);
    });

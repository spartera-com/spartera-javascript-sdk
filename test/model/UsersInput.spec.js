...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiSdk.UsersInput();
  });
  ...
  describe('UsersInput', function() {
    it('should create an instance of UsersInput', function() {
      ...
      //var instance = new SparteraApiSdk.UsersInput();
      //expect(instance).to.be.a(SparteraApiSdk.UsersInput);
    });
    ...
    it('should have the property marketingOptOut (base name: "marketing_opt_out")', function() {
      // uncomment below and update the code to test the property marketingOptOut
      //var instance = new SparteraApiSdk.UsersInput();
      //expect(instance).to.be();
    });

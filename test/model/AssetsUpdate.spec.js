...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.AssetsUpdate();
  });
  ...
  describe('AssetsUpdate', function() {
    it('should create an instance of AssetsUpdate', function() {
      ...
      //var instance = new SparteraApiDocumentation.AssetsUpdate();
      //expect(instance).to.be.a(SparteraApiDocumentation.AssetsUpdate);
    });

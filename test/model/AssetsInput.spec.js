...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.AssetsInput();
  });
  ...
  describe('AssetsInput', function() {
    it('should create an instance of AssetsInput', function() {
      ...
      //var instance = new SparteraApiDocumentation.AssetsInput();
      //expect(instance).to.be.a(SparteraApiDocumentation.AssetsInput);
    });

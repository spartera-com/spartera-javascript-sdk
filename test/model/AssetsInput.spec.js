...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiSdk.AssetsInput();
  });
  ...
  describe('AssetsInput', function() {
    it('should create an instance of AssetsInput', function() {
      // uncomment below and update the code to test AssetsInput
      //var instance = new SparteraApiSdk.AssetsInput();
      //expect(instance).to.be.a(SparteraApiSdk.AssetsInput);
    });

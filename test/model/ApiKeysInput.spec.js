...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiSdk.ApiKeysInput();
  });
  ...
  describe('ApiKeysInput', function() {
    it('should create an instance of ApiKeysInput', function() {
      // uncomment below and update the code to test ApiKeysInput
      //var instance = new SparteraApiSdk.ApiKeysInput();
      //expect(instance).to.be.a(SparteraApiSdk.ApiKeysInput);
    });

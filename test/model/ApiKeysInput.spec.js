...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.ApiKeysInput();
  });
  ...
  describe('ApiKeysInput', function() {
    it('should create an instance of ApiKeysInput', function() {
      ...
      //var instance = new SparteraApiDocumentation.ApiKeysInput();
      //expect(instance).to.be.a(SparteraApiDocumentation.ApiKeysInput);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiSdk.EndpointsInput();
  });
  ...
  describe('EndpointsInput', function() {
    it('should create an instance of EndpointsInput', function() {
      // uncomment below and update the code to test EndpointsInput
      //var instance = new SparteraApiSdk.EndpointsInput();
      //expect(instance).to.be.a(SparteraApiSdk.EndpointsInput);
    });

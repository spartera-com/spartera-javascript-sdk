...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.ApiKeys();
  });
  ...
  describe('ApiKeys', function() {
    it('should create an instance of ApiKeys', function() {
      ...
      //var instance = new SparteraApiDocumentation.ApiKeys();
      //expect(instance).to.be.a(SparteraApiDocumentation.ApiKeys);
    });

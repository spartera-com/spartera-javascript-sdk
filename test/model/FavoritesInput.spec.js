...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.FavoritesInput();
  });
  ...
  describe('FavoritesInput', function() {
    it('should create an instance of FavoritesInput', function() {
      ...
      //var instance = new SparteraApiDocumentation.FavoritesInput();
      //expect(instance).to.be.a(SparteraApiDocumentation.FavoritesInput);
    });

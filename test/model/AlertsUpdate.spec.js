...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.AlertsUpdate();
  });
  ...
  describe('AlertsUpdate', function() {
    it('should create an instance of AlertsUpdate', function() {
      ...
      //var instance = new SparteraApiDocumentation.AlertsUpdate();
      //expect(instance).to.be.a(SparteraApiDocumentation.AlertsUpdate);
    });

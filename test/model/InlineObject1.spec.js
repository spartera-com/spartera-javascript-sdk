...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instance = new SparteraApiDocumentation.InlineObject1();
      //expect(instance).to.be.a(SparteraApiDocumentation.InlineObject1);
    });

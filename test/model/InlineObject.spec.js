...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instance = new SparteraApiDocumentation.InlineObject();
      //expect(instance).to.be.a(SparteraApiDocumentation.InlineObject);
    });

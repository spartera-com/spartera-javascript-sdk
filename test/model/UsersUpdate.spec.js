...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiSdk.UsersUpdate();
  });
  ...
  describe('UsersUpdate', function() {
    it('should create an instance of UsersUpdate', function() {
      // uncomment below and update the code to test UsersUpdate
      //var instance = new SparteraApiSdk.UsersUpdate();
      //expect(instance).to.be.a(SparteraApiSdk.UsersUpdate);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.UsersUpdate();
  });
  ...
  describe('UsersUpdate', function() {
    it('should create an instance of UsersUpdate', function() {
      ...
      //var instance = new SparteraApiDocumentation.UsersUpdate();
      //expect(instance).to.be.a(SparteraApiDocumentation.UsersUpdate);
    });

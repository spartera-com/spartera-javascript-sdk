...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiSdk.PostPublicationsInput();
  });
  ...
  describe('PostPublicationsInput', function() {
    it('should create an instance of PostPublicationsInput', function() {
      // uncomment below and update the code to test PostPublicationsInput
      //var instance = new SparteraApiSdk.PostPublicationsInput();
      //expect(instance).to.be.a(SparteraApiSdk.PostPublicationsInput);
    });

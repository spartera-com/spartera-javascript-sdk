...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.ApiKeysUpdate();
  });
  ...
  describe('ApiKeysUpdate', function() {
    it('should create an instance of ApiKeysUpdate', function() {
      ...
      //var instance = new SparteraApiDocumentation.ApiKeysUpdate();
      //expect(instance).to.be.a(SparteraApiDocumentation.ApiKeysUpdate);
    });

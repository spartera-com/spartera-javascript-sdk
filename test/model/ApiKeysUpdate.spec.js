...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiSdk.ApiKeysUpdate();
  });
  ...
  describe('ApiKeysUpdate', function() {
    it('should create an instance of ApiKeysUpdate', function() {
      // uncomment below and update the code to test ApiKeysUpdate
      //var instance = new SparteraApiSdk.ApiKeysUpdate();
      //expect(instance).to.be.a(SparteraApiSdk.ApiKeysUpdate);
    });

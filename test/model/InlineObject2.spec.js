...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SparteraApiDocumentation.InlineObject2();
  });
  ...
  describe('InlineObject2', function() {
    it('should create an instance of InlineObject2', function() {
      ...
      //var instance = new SparteraApiDocumentation.InlineObject2();
      //expect(instance).to.be.a(SparteraApiDocumentation.InlineObject2);
    });
